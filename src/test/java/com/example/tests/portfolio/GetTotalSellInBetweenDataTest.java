...
import com.example.screensData.mcalc.GetTotalSellInBetweenData;
...
/**
 * Test class for GetTotalSellInBetweenData - Testing 5 calculation methods
 */
public class GetTotalSellInBetweenDataTest {

    private static final Logger logger = Logger.getLogger(GetTotalSellInBetweenDataTest.class);
    private OracleDBConnection dbConnection;
    private GetTotalSellInBetweenData totalSellData;
    ...
    public void setupDatabase() {
        try {
            ...
            totalSellData = new GetTotalSellInBetweenData(dbConnection);
    ...
    public void testGetTotalSellByNinAndCompany() {
        ...
        GetTotalSellInBetweenData allDatesData = new GetTotalSellInBetweenData(dbConnection);
    ...
    public void testGetTotalAmountByType() {
        ...
        GetTotalSellInBetweenData typeData = new GetTotalSellInBetweenData(dbConnection);
    ...
    public void testGetTotalSellByNinBetweenDates() {
        ...
        GetTotalSellInBetweenData ninData = new GetTotalSellInBetweenData(dbConnection);
    ...
    public void testGetTransactionCount() {
        ...
        GetTotalSellInBetweenData countData = new GetTotalSellInBetweenData(dbConnection);
