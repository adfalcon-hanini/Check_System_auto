...
/**
 * Utility class for managing BUY orders
 * Uses NIN: 12240
 *
 * Refactored to extend BaseOrderManager following DRY principle
 */
public class PlacedBuyOrder extends BaseOrderManager {

    private static final String DEFAULT_BUY_NIN = "12240";

    /**
     * Constructor
     * @param dbConnection Database connection instance
     */
    public PlacedBuyOrder(OracleDBConnection dbConnection) {
        super(dbConnection, OrderType.BUY, DEFAULT_BUY_NIN);
    }

    /**
     * Get buy orders for the default NIN
     * @return true if orders found, false otherwise
     */
    public boolean getBuyOrders() {
        return getOrders();
    }

    /**
     * Get buy orders for a specific NIN
     * @param nin Client NIN
     * @return true if orders found, false otherwise
     */
    public boolean getBuyOrders(String nin) {
