 ...
 */
public class GetTotalComissionSellInBetweenData {

    private static final Logger logger = Logger.getLogger(GetTotalComissionSellInBetweenData.class);
     ...
     */
    public GetTotalComissionSellInBetweenData(OracleDBConnection dbConnection) {
